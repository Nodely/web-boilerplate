...
export default () => (
  <div className="container">
      ...
      <div id="triple-first" className="col-md-4 triple">
        <div className="zone zone-triple-first">
          <article className="widget-triple-first widget-html-widget widget">
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur a nibh ut tortor dapibus
                            vestibulum. Aliquam vel sem nibh. Suspendisse vel condimentum tellus.
            </p>
          </article>
        </div>
      </div>
    ...
    <BS.Row>
      ...
      <BS.Col md={4} className="copyright text-right">
        Powered by
        {" "}
        <a href="https://nodely.me">Nodely</a>
      </BS.Col>
    </BS.Row>
