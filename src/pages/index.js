...
export const index = () => (
  <BS.Col md={6} mdOffset={3} className="zone-content">
    <article>
      ...
      <p className="lead">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sodales cursus
                fringilla. Praesent non enim urna. Praesent in tellus augue, eget egestas purus.
      </p>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sodales cursus fringilla. Cras
          ...
          adipisicing elit. Facilis architecto incidunt cum soluta iste culpa tenetur dolorum maiores nihil
                laudantium blanditiis rerum sapiente nesciunt consequatur quasi dolorem dolor in tempora.
      </p>
    </article>
  </BS.Col>
)
